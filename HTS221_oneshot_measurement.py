...
def HTS221_oneshot_measurement():
	...
	#               0x85(133)       Power ON
	bus.write_byte_data(0x5F, 0x20, 0x80)
	
	time.sleep(0.5) # Allow device to power, fetch configuration data
	
	bus.write_byte_data(0x5F, 0x21, 0x1) # One shot conversion
	
	time.sleep(0.5) # Allow device to enact one shot sample
